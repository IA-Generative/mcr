...
class SpeechToTextPipeline:
    ...
    def transcribe(  # type: ignore[explicit-any]
        ...
        Args:
            ...
            transcription_model (WhisperModel): The loaded Whisper transcription model.
    ...
    def diarize(
        ...
        Args:
            audio_bytes (BytesIO): The input audio bytes.
            diarization_pipeline (Pipeline): The pyannote audio pipeline for speaker diarization.
