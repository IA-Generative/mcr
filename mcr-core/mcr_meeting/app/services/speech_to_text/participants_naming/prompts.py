...
2. PRÉSENTATION PAR UN TIERS : un autre interlocuteur présente explicitement LOCUTEUR_XX.
   ✓ LOCUTEUR_01 : "Je vous présente Julie, notre chef de projet."
      → Julie est attribuée à LOCUTEUR_XX qui prend la parole juste après, ou à celui désigné.
   ✓ LOCUTEUR_01 : "Marc, tu peux nous expliquer ?"
      → Marc est attribué à LOCUTEUR_XX qui répond.

3. INTERPELLATION DIRECTE : un interlocuteur s'adresse à LOCUTEUR_XX en le nommant,
   et LOCUTEUR_XX répond (confirmation implicite).
   ✓ LOCUTEUR_01 : "Qu'en penses-tu, Julie ?"
      LOCUTEUR_02 : "Je pense que..." → Julie est attribuée à LOCUTEUR_02.
...
Tu peux renvoyer SOIT la liste complète des participants, SOIT uniquement les participants
ajoutés ou modifiés par ce nouvel extrait. Tout speaker_id présent dans le JSON courant mais
absent de ta réponse sera automatiquement préservé tel quel — il est donc inutile de réémettre
des participants pour lesquels tu n'as aucune information nouvelle.
...
✓ Présentation explicite de LOCUTEUR_XX par un tiers.
✓ Interpellation directe de LOCUTEUR_XX par son nom, suivie d'une réponse.
