...
from mcr_meeting.app.services.report_task_service import get_formatted_report_from_s3
...
def request_deliverable(
    ...
    deliverable = create_pending_deliverable(meeting_id=meeting.id, type=type)
...
def get_deliverable_file(
    ...
    buffer = get_formatted_report_from_s3(meeting)
