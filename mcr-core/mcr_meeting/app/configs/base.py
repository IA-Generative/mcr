...
class Speech2TextSettings(BaseSettings):
    ...
    NOISE_FILTERS: str = "highpass=f=80,afftdn=nf=-25,agate=threshold=0.015:ratio=2,equalizer=f=250:width_type=h:width=200:g=-2,equalizer=f=3500:width_type=h:width=2500:g=3,acompressor=threshold=-18dB:ratio=2.5:attack=15:release=200:makeup=1"
    NOISE_LOUDNORM: str = "loudnorm=I=-18:LRA=6:TP=-1.5"
