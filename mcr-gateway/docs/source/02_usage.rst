...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build mcr_gateway_api

3. Run the API Service by::

    $ ./docker-compose.sh run --service-ports --rm mcr_gateway_api
...
7. Run the service via::
    ...
    $ python mcr_gateway_api/main.py
...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build test_mcr_gateway_api

3. Run the API Service by::

    $ ./docker-compose.sh run test_mcr_gateway_api
