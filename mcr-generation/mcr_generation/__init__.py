...
# Resolve path to env files in project root (2 levels up from this file)
...
mcr_generation_dir = Path(__file__).resolve().parents[2]

ENV_FILE = mcr_generation_dir / ".env"
ENV_LOCAL_HOST_FILE = mcr_generation_dir / ".env.local.host"
ENV_LOCAL_DOCKER_FILE = mcr_generation_dir / ".env.local.docker"
