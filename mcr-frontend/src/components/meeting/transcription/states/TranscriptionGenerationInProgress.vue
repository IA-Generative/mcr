  ...
  <div class="flex flex-col items-center gap-6">
    ...
    <div class="text-center max-w-2xl">
      <h3 class="text-xl font-bold mb-4 text-[var(--blue-france-sun-113-625)]">
        {{ $t('meeting.transcription.transcription-generation-in-progress.title') }}
      </h3>
      <p class="text-lg text-[var(--default-text-grey)]">
        {{ $t('meeting.transcription.transcription-generation-in-progress.description') }}
      </p>
    </div>
    ...
    >
      <p>
        <span class="font-bold">
          {{ $t('meeting.transcription.transcription-generation-in-progress.reachement-deadline') }}
        </span>
      </p>
    </div>
  </div>
